                                                ...
                                                {isDropdownOpen && (
                                                    <div className="absolute left-0 top-full mt-2 w-full bg-[#292929] border border-[#292929] rounded-md z-50 gradient-slate px-[12px] pb-[16px] pt-[8px] h-[210px] overflow-auto">
                                                        ...
                                                        {categories.map((category, idx) => (
                                                            ...
                                                            >
                                                                <p className={`text-[16px] font-normal ${selectedCategory === category.label ? "text-[#00d059]" : "text-[#FFFFFF]"}`}>
                                                                    {category.label}
                                                                </p>
                                            ...
                                            <div className="relative w-full sm:w-[50%] py-[13px] mt-[8px] w-full rounded-md border border-[#292929] gradient-slate px-[12px]">
                                                ...
                                                <div className="flex items-center justify-between cursor-pointer" onClick={toggleDropdownlicensed}>
                                                    <div className="flex w-[95%] flex-col">
                                                        <p className="text-base text-white text-white truncate-styling2 font-extrabold pb-[4px] uppercase">is the venue licensed for the event type?</p>
                                                ...
                                                {isDropdownOpenvenue && (
                                                    <div className="absolute left-0 top-full mt-2 w-full bg-[#292929] border border-[#292929] rounded-md z-50 gradient-slate px-[12px] pb-[16px] pt-[8px] h-[210px] overflow-auto">
                                                        ...
                                                        <div className="flex items-center gap-4 mb-4">
                                                            ...
                                                            />
                                                            <button
                                                                onClick={handleAddCategoryvenue}
                                                                className="bg-green-500 text-white px-4 py-2 rounded-md text-sm"
                                                            >
                                                                Add
                                                            </button>
                                        ...
                                        <div className="flex flex-col sm:flex-row items-start gap-[16px] sm:gap-[24px] w-full common-container">
                                            ...
                                            <form className="w-full max-w-md gradient-slate gradient-slate-input rounded-lg shadow-lg py-[16px] px-[12px] space-y-4">
                                                <div className="relative space-y-0">
                                                    ...
                                                    <label
                                                        htmlFor="fileUpload"
                                                        className={`gallery-box-same border-none text-[#8F8F8F] font-bold text-[12px] placeholder:text-[12px] placeholder:font-bold gradient-slatee rounded-md cursor-pointer flex items-end ${galleryFiles?.length > 0 ? "gallery-box" : "gallery-tops"
                                                            }`}
                                                    >
                                                        <span>
                                                            {galleryFiles?.length > 0
                                                                ? `${galleryFiles.length} file(s) selected`
                                                                : "Attach Licensed Copy"}
                                                        </span>
                                                        <input
                                                            type="file"
                                                            multiple
