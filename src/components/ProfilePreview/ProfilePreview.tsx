      ...
      <div className="flex flex-col md:flex-row w-full items-center justify-between">
        <div className="flex flex-col w-[100%] md:flex-row gap-[24] md:gap-[32px] justify-center items-center md:justify-start md:items-start">
          ...
          <div className="w-full md:w-fit ">
            ...
            <p className="font-normal text-center lg:text-start text-sm mt-[24px] lg:mt-[8px] mb-[16px] lg:mb-[24px]">Sit vel diam habitant ipsum volutpat. Quisque porttitor turpis orci at. Nibh quis nisi amet mi fames dictum fames orci.</p>
