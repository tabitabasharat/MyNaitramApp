...
const Report: React.FC<ReportProps> = ({ open, onClose }) => {
                ...
                >
                    <DialogContent className="w-[650px] ">
                        ...
                        <DialogFooter className="w-full md:flex-row flex flex-row gap-[12px]">
                            ...
                            <Button className="text-sm font-extrabold text-center w-full rounded-[100px] py-[12px] text-[black] bg-[#00D059]">Report</Button>
                        </DialogFooter>
                    </DialogContent>
                </form>
            </Form>
