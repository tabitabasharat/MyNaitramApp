...
import { CaretLeft, Clock, SealCheck, StripeLogo } from "@phosphor-icons/react/dist/ssr";
        ...
        <DialogHeader>
          <DialogTitle className="font-bold text-2xl">
            <div className="flex items-center gap-4 pb-4">
              <button onClick={() => handleNext("CompleteYourProfile")} className="bg-white/10 p-2 w-fit rounded-full cursor-pointer">
            ...
            <div className="border border-muted p-3 rounded-lg">
              <div className="flex gap-4">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <p className="text-primary text-sm">{ConvertDate(EventData?.startTime)}</p>
                    <p className="font-bold leading-[1.2] my-1">{EventData?.name}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex justify-between">
              <p style={{ fontWeight: "bold" }} className="font-light">
                {ticketType}
              </p>
