    ...
    <div className="pt-[120px] pb-[59.12px] lg:pb-[26.25px] px-[24px] bank-bg-effect lg:px-[100px] xl:px-[216px] md:pt-[132px] mx-auto">
      ...
      {[...Array(3)].map((_, index) => (
        ...
        >
          ...
          <div className="flex justify-between items-center">
            <p className="text-sm font-normal text-[#E6E6E6]">Title of Account</p>
            <p className="text-[#E6E6E6] text-base font-bold">John Williams</p>
          </div>
          <div className="flex justify-between items-center">
            <p className="text-sm font-normal text-[#E6E6E6]">Account Number</p>
            <p className="text-[#E6E6E6] text-base font-bold">126283399384039</p>
          </div>
          <div className="flex justify-between items-center">
      ...
      <div className="flex mb-[32px] w-full mt-[20px] lg:mt-[32px] md:w-[676px]">
