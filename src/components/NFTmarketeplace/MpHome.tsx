...
const MpHome = () => {
  ...
  {images.map((src, index) => (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 pl-[15px] pr-[15px] pb-[15px] w-full text-white z-20">
        ...
        <div className="hidden group-hover:block mt-[16px]">
          <p className="text-[12px] sm:text-[14px] font-[400] leading-[16.8px] text-left text-[#FFFFFF]">
            Forem ipsum dolor sit amet, consectetur <br /> adipiscing elit.
            Nunc vulputate libero et velit <br /> interdum, ac aliquet odio
            mattis.
          </p>
      ...
      {/* Gradient Border */}
      <div
        className="  absolute inset-0 rounded-[8px] opacity-0 group-hover:opacity-100 transition-all duration-300"
