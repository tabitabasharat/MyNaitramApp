  ...
  const FilterButton1 = () => (
    <>
      <div className="flex relative flex-col" ref={dropdownRef}>
        ...
        {isDropdownVisible && (
          <div className="flex flex-col min-[501px]:hidden absolute z-[1] top-[58px] right-[0px] p-[16px] gradient-slate rounded-[8px] border border-[#292929] mt-[8px] gap-[16px]">
            {/* Filter Dropdown */}
            <div
            ...
            >
              ...
              >
                <span className="text-sm font-normal text-[#BFBFBF]">Recently Received</span>
                <Image
                src={arrowdown}
                  alt="dropdown-icon"
                  width={22}
              ...
              {isOpen && (
                <div className="absolute z-10 mt-2 w-full gradient-slate border border-[#292929] rounded-md shadow-lg">
                  <ul className="py-1">
                    ...
                    {["Option 1", "Option 2", "Option 3"].map((filter) => (
                      <li
                        key={filter}
            ...
            >
              <button
                ...
                className="flex items-center justify-between w-full gradient-slate border border-[#292929] text-white p-[15px] rounded-md"
              >
                <span className="text-sm font-normal text-[#BFBFBF]">Status</span>
                <Image
              src={arrowdown}
                  alt="dropdown-icon"
                  width={24}
              ...
              {isOpenchain && (
                <div className="absolute z-10 mt-2 w-full gradient-slate border border-[#292929] rounded-md shadow-lg">
                  <ul className="py-1">
                    ...
                    {["Chain 1", "Chain 2", "Chain 3"].map((filter) => (
                      <li
                        key={filter}
                        className="px-4 py-2 cursor-pointer"
                        onClick={() => console.log(filter)}
            ...
            >
              <button
                ...
                className="flex items-center justify-between w-full gradient-slate border border-[#292929] text-white p-[15px] rounded-md"
              >
                <span className="text-sm font-normal text-[#BFBFBF]">Chains</span>
                <Image
        src={arrowdown}
                  alt="dropdown-icon"
                  width={24}
              ...
              {isOpenrecent && (
                <div className="absolute z-10 mt-2 w-full gradient-slate border border-[#292929] rounded-md shadow-lg">
                  <ul className="py-1">
                    ...
                    {["Recent 1", "Recent 2", "Recent 3"].map((filter) => (
                      <li
                        key={filter}
                        className="px-4 py-2 cursor-pointer"
                        onClick={() => console.log(filter)}
