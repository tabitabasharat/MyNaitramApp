  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "text-[#00A849] hover:bg-black hover:text-[#00A849] border border-solid border-[#00A849] rounded-[4px] focus:text-[#00A849] focus:bg-black", // Keep rounded-[4px]
        day_today: "bg-black text-[white] dark:bg-slate-800 dark:text-slate-50",
        day_outside:
